                        ...
                        <div class="card mb-8 rounded-4">
                            ...
                            <div class="card-body p-7">
                                <form class="form-border-1">
                                    ...
                                    <div class="mb-8">
                                        <label class="mb-4 fs-13px ls-1 fw-bold text-uppercase" for="tax-rate">Tax
                                            rate</label>
                                        <input type="text" placeholder="%" class="form-control" id="tax-rate">
                                    </div>
                                ...
                                <form class="form-border-1">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-8">
                                                <label for="width"
                                                    class="mb-4 fs-13px ls-1 fw-bold text-uppercase">Width</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-8">
                                                <label for="height"
                                                    class="mb-4 fs-13px ls-1 fw-bold text-uppercase">Height</label>
                                                <input type="text" placeholder="inch" class="form-control"
                                                    id="height">
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-8">
                                        <label for="weight"
                                            class="mb-4 fs-13px ls-1 fw-bold text-uppercase">Weight</label>
                                        <input type="text" placeholder="gam" class="form-control" id="weight">
                                    </div>
                                    <div class="mb-8">
                                        <label for="shipping-fee" class="mb-4 fs-13px ls-1 fw-bold text-uppercase">Shipping
                                            fees</label>
                                        <input type="text" placeholder="$" class="form-control" id="shipping-fee">
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-7">
                                <div class="row mx-n3">
                                    ...
                                    <div class="mb-5 col-12 px-3">
                                        <label for="tag"
                                            class="mb-4 fs-13px ls-1 fw-bold text-uppercase">Tags</label>
