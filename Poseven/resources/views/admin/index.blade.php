                            ...
                            <div class="card-body">
                                ...
                                <div class="new-member-list">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-9">
                                        ...
                                        <a href="#" class="btn btn-xs btn-primary"><i class="fas fa-plus"></i>
                                            Add</a>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-9">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="w-40px me-5">
                                                <img src="#" data-src="../assets//images/dashboard/avatar-3.png"
                                                    alt class="lazy-image rounded-circle" height="40" width="40">
                                            </div>
                                            <div>
                                                <h6 class="fs-14px mb-0 lh-1">Patric Adams</h6>
                                                <p class="text-muted fs-12px mb-0">Sanfrancisco</p>
                            ...
                            <div class="card-body p-0">
                                ...
                                <ul class="verti-timeline list-unstyled fs-13px mx-4">
                                    ...
                                    <li class="event-list d-flex align-items-center position-relative active">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <div class="me-6">
                                                <h6 class="fs-13px mb-0"><span class="d-inline-block me-6 w-50px">17
                                                        May</span>
                                                    <svg class="icon text-body-emphasis">
                                                        <use xlink:href="#arrow-right-long"></use>
                                                    </svg>
                                    ...
                                    <li class="event-list d-flex align-items-center position-relative">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <div class="me-6">
                                                <h6 class="fs-13px mb-0"><span class="d-inline-block me-6 w-50px">13
                                                        May</span>
                                                    <svg class="icon text-body-emphasis">
                                                        <use xlink:href="#arrow-right-long"></use>
                                                    </svg>
                                    ...
                                    <li class="event-list d-flex align-items-center position-relative">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <div class="me-6">
                                                <h6 class="fs-13px mb-0"><span class="d-inline-block me-6 w-50px">26
                                                        Mar</span>
                                                    <svg class="icon text-body-emphasis">
                                                        <use xlink:href="#arrow-right-long"></use>
                                                    </svg>
